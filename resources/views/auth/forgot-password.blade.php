...
<head>
    ...
    <title>Lupa Password · EWS Banjir Rob</title>
        ...
        <main class="relative flex items-center justify-center overflow-hidden p-4 sm:p-6">
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-6 hidden lg:block">
                    <h1 class="font-display text-2xl font-bold tracking-tight">Lupa Password?</h1>
                    <p class="mt-1 text-sm text-[var(--color-text-muted)]">Masukkan email Anda untuk menerima kode reset.</p>
                </div>
                ...
                <div class="card p-6 sm:p-8">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-[var(--color-text-muted)] mb-1.5">Email</label>
                            <input
                                type="email"
                                id="email"
                                name="email"
                    ...
                    <div class="mt-4 flex items-center justify-between text-sm">
                        <a href="{{ route('login') }}" class="text-[var(--color-accent)] hover:underline">← Kembali ke login</a>
                    </div>
                </div>

                <p class="mt-6 text-center text-xs text-[var(--color-text-muted)]">
                    Belum punya akun? <a href="{{ route('register') }}" class="text-[var(--color-accent)] hover:underline">Daftar di sini</a>
                </p>
            </div>
        </main>
