...
final class DeviceController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $devices = Device::query()
            ...
            ->when(
                in_array($status, array_column(DeviceStatus::cases(), 'value'), true),
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('devices')
            ->with('status', "Device {$data['device_code']} berhasil ditambahkan.");
    }
    ...
    public function update(Request $request, Device $device): RedirectResponse
    {
        ...
        return redirect()
            ->route('devices')
            ->with('status', "Device {$device->device_code} berhasil diperbarui.");
    }
    ...
    private function validated(Request $request, ?Device $device = null): array
    {
        return $request->validate([
            ...
            'device_code.regex' => 'Kode device hanya boleh huruf, angka, tanda hubung, dan garis bawah.',
        ], [
