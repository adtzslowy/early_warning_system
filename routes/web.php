...
Route::prefix("sign-in")
    ...
    ->group(function () {
        ...
        Route::post("/verification", [AuthController::class, "login"])->name(
            "proses",
        );
    });
...
Route::prefix("dashboard")
    ...
    ->group(function () {
        ...
        Route::get("/devices/{device:device_code}/snapshot", [
...
Route::prefix("devices")
    ...
    ->group(function () {
        ...
        Route::post("/", [DeviceController::class, "store"])
            ->middleware("permission:create devices")
            ->name("devices.store");
        Route::get("/{device:device_code}/edit", [
            DeviceController::class,
            "edit",
        ])
            ->middleware("permission:edit devices")
            ->name("devices.edit");
        Route::patch("/{device:device_code}", [
            DeviceController::class,
            "update",
        ])
            ->middleware("permission:edit devices")
            ->name("devices.update");
        Route::delete("/{device:device_code}", [
            DeviceController::class,
            "destroy",
        ])
